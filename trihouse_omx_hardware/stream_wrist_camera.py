...
trihouse_omx/ 바깥 코드를 재사용한다 — vision_ai/robot/media/stream_hub/ingress.py가
...
# vision_ai/robot/media/stream_hub/ingress.py를 그대로 재사용하기 위해 저장소 루트를
# sys.path에 추가한다 — 파일은 안 건드리고 import만 한다.
_REPO_ROOT = Path(__file__).resolve().parents[1]
sys.path.insert(0, str(_REPO_ROOT))

from vision_ai.robot.media.stream_hub.ingress import (  # noqa: E402
    StreamIdentity,
    UsbIngressConfig,
    UsbVideoFormat,
    VideoEncoder,
