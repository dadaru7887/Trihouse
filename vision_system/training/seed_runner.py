...
**모듈로 실행한다** — `python -m vision_system.training.seed_runner`.
...
from vision_system.training.config_loader import config_for_seed, load_experiment_config
from vision_system.training.orchestrator import run_pipeline
