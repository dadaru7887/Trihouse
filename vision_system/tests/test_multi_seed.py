...
from vision_system.training.multi_seed import aggregate_seed_runs, build_seed_command, select_deployment_model
...
def test_seed_command_sets_pythonhashseed_and_uses_separate_run(tmp_path: Path) -> None:
    ...
    assert command == [
        "/venv/bin/python", "-m", "vision_system.training.seed_runner",
