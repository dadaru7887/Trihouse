...
-- EN: These provisional poses mirror the new_map_2 JSONL so unfinished measurements are visible in development.
-- KO: 아래 임시 pose는 new_map_2 JSONL과 일치시키며, 남은 실측값은 해당 JSONL과 함께 갱신한다.
INSERT INTO locations
...
VALUES
  ...
  (@wh_amb_id, 'WH-AMB-01-NARROW-ENTRY', 'Ambient Storage Narrow Entry', 'staging',
   'ambient', 'ambient', 'new_map_2', 'ambient_storage_narrow_entry',
   1.010244055594586, 0.9167344977253539, -0.08675495954950327, 'available',
   JSON_OBJECT('coordinate_source', 'j_narrow3_rule_based_docking_1.py', 'provisional', false)),
  (@wh_chl_id, 'WH-CHL-01-NARROW-ENTRY', 'Chilled Storage Narrow Entry', 'staging',
   'chilled', 'chilled', 'new_map_2', 'chilled_storage_narrow_entry',
   1.1013315221281241, -0.10045055614140724, 3.1029342608092607, 'available',
   JSON_OBJECT('coordinate_source', 'j_narrow3_rule_based_docking_1.py', 'provisional', false)),
...
VALUES
  ('JOB-DEV-001', 'outbound', 'normal', 'queued', 'W-FIELD-01',
