...
```bash
git add control_ui/rmf_control_ui/data/import/trihouse_test_01_physical_features.new_map_2.jsonl config/narrow_zones.new_map_2.yaml db/seeds/seed_dev.sql db/seeds/seed_hardware.sql tests/physical_readiness/test_02_physical_seed_data.py trihouse_pinky/test/test_narrow_zone_pilot.py
