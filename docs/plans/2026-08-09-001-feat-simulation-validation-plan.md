...
- **파일:** `docs/setup/trihouse-integrated-bringup.md`,
  `docs/notebooks/trihouse_gazebo_and_hardware_check.ipynb`,
...
- **요구사항:** R2, R9. **의존성:** U1.
- **파일:** `compose.test.yaml`, `db/schema_mysql.sql`, `db/seed_dev.sql`,
  `fms_gateway/app/main.py`, `fms_gateway/app/repositories.py`,
  `fms_gateway/tests/integration/`, `docs/setup/fms-gateway-setup.md`.
