...
`docs/development/code_guide.md`를 따른다.

## 참고 자료

- `docs/requirements/workflows/inbound_workflow.pdf`
- `docs/requirements/workflows/outbound_workflow.pdf`의 `출고 v2`
- `docs/requirements/workflows/emergency_workflow.pdf` 중 사람 위급상황 흐름
- `docs/requirements/user_requirements.md`
- `docs/architecture/vision_data_flow.md`
- `docs/architecture/robot_arm_safety.md`
- `docs/architecture/recovery_memory.md`
