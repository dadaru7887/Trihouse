...
```
```bash
scripts/p0_reset.sh /home/newuser/Trihouse/control_ui/rmf_control_ui/data/rmf_maps/new_map_2.yaml   # 경로로
```

이름을 주면 `control_ui/rmf_control_ui/data/rmf_maps/<이름>.yaml` 을 쓴다. 경로를 주면
