...
from vision_ai.models.perception.trainer.multi_seed import aggregate_seed_runs, build_seed_command, select_deployment_model
...
def test_seed_command_sets_pythonhashseed_and_uses_separate_run(tmp_path: Path) -> None:
    ...
    assert command == [
        "/venv/bin/python", "-m", "vision_ai.models.perception.trainer.seed_runner",
...
def test_the_dataset_override_reaches_every_seed_subprocess() -> None:
    ...
    from vision_ai.models.perception.trainer.multi_seed import build_seed_command
...
def test_the_seed_runner_accepts_the_dataset_override() -> None:
    ...
    from vision_ai.models.perception.trainer.seed_runner import build_parser
