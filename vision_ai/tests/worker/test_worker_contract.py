...
from vision_ai.robot.marker.edge_perception import ArucoObservation, QrObservation  # noqa: E402
from vision_ai.robot.marker.edge_worker import (  # noqa: E402
    VisionEdgeWorker,
    VisionRequest,
    VisionRequestError,
)
...
CAMERAS_CONFIG = Path(__file__).resolve().parents[3] / "config" / "cameras.yaml"
