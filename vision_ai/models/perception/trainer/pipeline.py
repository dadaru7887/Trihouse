...
여기서 하나로 모은다.
    ...
    python -m vision_ai.models.perception.trainer.pipeline run       --data <data.yaml>       # 단일 run
...
seed 하나를 돌리는 것은 `vision_ai.models.perception.trainer.seed_runner` 다. multi-seed 실험이
