...
from model.perception.segmentation.training.reproducibility import seed_everything
...
def _resolve_augmentation_source(source: Path | None) -> Path:
    ...
    # model/perception/segmentation/training/trainer/yoloe_trainer.py -> 저장소 루트
