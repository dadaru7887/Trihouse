...
**모듈로 실행한다** — `python -m model.perception.segmentation.training.seed_runner`.
...
from model.perception.segmentation.training.config_loader import config_for_seed, load_experiment_config
from model.perception.segmentation.training.orchestrator import run_pipeline
