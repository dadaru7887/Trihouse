...
def test_training_writes_a_bundle_the_runtime_can_load(tmp_path) -> None:
    ...
    from model.worker.person.classifier import FallenClassifier
    from model.worker.person.training.train import train_classifier
...
def test_a_missing_split_is_refused(tmp_path) -> None:
    from model.worker.person.training.train import DatasetError, train_classifier
...
def test_the_cli_takes_every_path_as_an_argument() -> None:
    ...
    from model.worker.person.training.train import build_parser
