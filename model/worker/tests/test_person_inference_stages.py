...
from model.worker.person.posture import (
    PostureConfig,
    PostureEstimator,
    mask_geometry,
)
from model.worker.person.worker import load_settings, parse_source
...
from model.worker.person.worker import resolve_camera_id  # noqa: E402
