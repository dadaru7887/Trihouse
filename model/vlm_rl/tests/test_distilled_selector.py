...
def test_gate_trusts_the_ensemble_when_unanimous_and_low_entropy(tmp_path) -> None:
    from model.vlm_rl.inference.distilled_selector import DistilledSelectorGate
...
REAL_ENSEMBLE = Path(
    "vision_system/vlm_rl/upstream_dev_driving/07_distillation/weights"
...
def test_absent_selector_environment_keeps_the_unchanged_goal_distance_path() -> None:
    from model.vlm_rl.inference.distilled_selector import build_selector_from_env
